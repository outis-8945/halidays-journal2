    ...
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
      <div className="relative overflow-hidden shadow-md pb-80 mb-6">
        <img
          ...
          alt={post.title}
          className="object-cover object-top rounded-t-lg lg:rounded-lg absolute h-50 w-full rounded-t-lg"
        />
      </div>
      <h1
        className="transition duration-700 text-center mb-8 cursor-pointer hover:text-violet-600 
      ...
      <div className="block lg:flex text-center justify-center mb-8 w-full">
        <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
          ...
          />
          <p className="ml-2 inline align-middle text-gray-700 text-lg">
            {post.author.name}
          </p>
        </div>
